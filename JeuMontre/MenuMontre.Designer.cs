...
namespace Snake
{
	partial class MenuMontre
	{
		...
		private System.Windows.Forms.NumericUpDown saisieTempsJeu;
		...
		private void InitializeComponent()
		{
			...
			this.saisieTempsJeu = new System.Windows.Forms.NumericUpDown();
			...
			((System.ComponentModel.ISupportInitialize)(this.saisieTempsJeu)).BeginInit();
			...
			// lblTempsJeu
			// 
			this.lblTempsJeu.Location = new System.Drawing.Point(12, 55);
			this.lblTempsJeu.Name = "lblTempsJeu";
			this.lblTempsJeu.Size = new System.Drawing.Size(113, 20);
			this.lblTempsJeu.TabIndex = 2;
			this.lblTempsJeu.Text = "Temps de jeu";
			this.lblTempsJeu.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			// 
			// lblVitesseSnake
			// 
			...
			// saisieTempsJeu
			// 
			this.saisieTempsJeu.Location = new System.Drawing.Point(170, 57);
			this.saisieTempsJeu.Maximum = new decimal(new int[] {
			600,
			0,
			0,
			0});
			this.saisieTempsJeu.Minimum = new decimal(new int[] {
			30,
			0,
			0,
			0});
			this.saisieTempsJeu.Name = "saisieTempsJeu";
			this.saisieTempsJeu.Size = new System.Drawing.Size(39, 20);
			this.saisieTempsJeu.TabIndex = 2;
			this.saisieTempsJeu.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			this.saisieTempsJeu.Value = new decimal(new int[] {
			30,
			0,
			0,
			0});
			...
			this.Controls.Add(this.saisieTempsJeu);
			...
			((System.ComponentModel.ISupportInitialize)(this.saisieTempsJeu)).EndInit();
